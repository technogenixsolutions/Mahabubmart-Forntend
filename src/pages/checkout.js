                  ...
                  <div className="grid grid-cols-6 gap-4 lg:gap-6 mt-10">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      <button
                        ...
                        className="from-[#1F6BBF] via-[#279FDF] to-[#00a4db] hover:from-[#155a9e] hover:via-[#1e88c8] hover:to-[#0090c2] transition-all focus:outline-none cursor-pointer  rounded py-3 text-center text-sm font-serif font-medium text-white flex justify-center w-full"
                      >
                        {isCheckoutSubmit ? (
          ...
          ✕
                      ...
                      <div className="flex flex-col sm:flex-row items-start justify-end">
                        <input
                          ...
                          className="form-input py-2 px-3 md:px-4 w-full appearance-none transition ease-in-out border text-input text-sm rounded-md h-12 duration-200 bg-white border-gray-200 focus:ring-0 focus:outline-none focus:border-[#1F6BBF] placeholder-gray-500 placeholder-opacity-75"
                        />
                        <button
                          onClick={handleCouponCode}
                          className="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border border-gray-200 rounded-md placeholder-white focus-visible:outline-none focus:outline-none px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 mt-3 sm:mt-0 sm:ml-3 md:mt-0 md:ml-3 lg:mt-0 lg:ml-3 hover:text-white hover:bg-gradient-to-r from-[#1F6BBF] via-[#279FDF] to-[#00a4db] h-12 text-sm lg:text-base w-full sm:w-auto"
                        >
                          {showingTranslateValue(
